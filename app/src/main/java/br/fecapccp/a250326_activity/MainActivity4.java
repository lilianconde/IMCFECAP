...
public class MainActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pesoText = findViewById(R.id.textT4Peso);
        alturaText = findViewById(R.id.textT4Altura);
        IMCText = findViewById(R.id.textT4Imc);

        pesoText.setText("Peso: "+peso);
        alturaText.setText("Altura: "+altura);
        IMCText.setText("IMC: "+IMC);

        btnFechar = findViewById(R.id.btnT4Fechar);
